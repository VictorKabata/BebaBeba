...
import com.vickikbt.bebabeba.utils.action
import com.vickikbt.bebabeba.utils.snackbar
...
fun Fragment.handleOpenGalleryPermissionResult(
    grantResults: IntArray,
    view: View?,
    openGalleryFunc: () -> Unit
) {
 ...
 *  */
fun Fragment.invokeFunctionWithPermission(
    permission: String,
    requestCode: Int,
    requiredFunction: () -> Unit
) {
 ...
 *  */
fun Fragment.requestToOpenGallery(
    requestCode: Int,
    openGalleryFunction: () -> Unit
) {
